...
class UserBase(BaseModel):
    ...
    email: str = Field(..., description="The email of the user", example="annoto@team-folivora.com")

class UserCreate(UserBase):
    """The fields required to create a new user"""
    password: str = Field(..., description="The password of the user", example="folivora!!!!11elf")
